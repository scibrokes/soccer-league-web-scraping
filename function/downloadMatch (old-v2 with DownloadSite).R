...
# categorize the teams in league/cup
  lg = as.list(as.character(tab2$leagueID$Name))
  names(lg)=as.character(tab2$leagueID$Name)
  team = list()
  ...
  tab2 = list(Table=tab2$Table, URL=tab2$URL, teamID=team, leagueID=tab2$leagueID,
               lnk=tab2$lnk,Rounds=tab2$Rounds)
  rm(tab2,team,lg)
# -------------------------------------------------------------------------------------
